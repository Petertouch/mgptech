    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/70 backdrop-blur-xl border-b border-white/5">
      <div className="container mx-auto px-6 py-3.5 flex items-center justify-between">
        <a href="#" className="flex items-center gap-3">
          <img src={logo} alt="OGF Real Estate Group LLC" className="h-10 w-auto" />
        </a>
        ...
        <a
          ...
          className="bg-[#25D366] text-white px-5 py-2.5 rounded-full font-medium text-sm hover:bg-[#1eba59] transition-all duration-300 hover:shadow-lg hover:shadow-[#25D366]/25 flex items-center gap-2"
        >
