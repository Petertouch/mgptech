...
const Hero = () => {
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden" aria-label="Inicio - OGF Real Estate">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-16 sm:pb-24">
        <div className="max-w-3xl">
          ...
          {/* Subheadline */}
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-7 sm:mb-10 max-w-xl opacity-0 animate-fade-in-up animation-delay-400 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in-up animation-delay-600">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1eba59] text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-semibold text-sm sm:text-base transition-all duration-300 hover:scale-[1.03] shadow-lg shadow-[#25D366]/20 hover:shadow-xl hover:shadow-[#25D366]/30"
            >
          ...
          {/* Trust Indicators */}
          <div className="mt-8 sm:mt-14 flex flex-wrap gap-6 opacity-0 animate-fade-in-up animation-delay-600">
