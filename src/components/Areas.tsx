...
const Areas = () => {
  return (
    <section id="areas" className="py-28 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {areas.map((area) => (
            ...
            >
              {/* Icon */}
              <div className="w-14 h-14 mx-auto mb-7 rounded-2xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-all duration-300">
